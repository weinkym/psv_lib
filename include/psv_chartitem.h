...
public:
    PSV_ChartItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param, QGraphicsItem * parent = 0 );
...
//    void clearAllCurve(void); //清除所有曲线
    ...
    virtual void setData(PSV::ATTRIBUTE_ROLE role, const QVariant &value, bool isUpdate);
...
//    enum LISTTYPE { E_LEFT = 20001, E_RIGHT, E_UP, E_DOWN};
    ...
    enum { E_CURVE_NAME = 10001, E_CURVE_TIME, E_PREVIOUS_TIME, E_NEXT_TIME, E_POINT_TYPE, E_AXIS_X,E_LABLE_TYPE};
    bool m_isStaHidden;
