...
{
public:
    PSV_AxisRightItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param, QGraphicsItem * parent = 0 );
    PSV_AxisRightItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param,const QStringList &list, QGraphicsItem * parent = 0 );
    ~PSV_AxisRightItem();
