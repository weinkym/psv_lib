...
void MainWindow::addChartRealItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartTimeItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
//    QString title = QString::fromLocal8Bit("曲线_time");
    ...
    for(int i = 0; i < 3; ++i)
    {
        ...
        curveParam.m_isUpdate = false;
        QMap<QTime,double> tempData = TestPublic::mapTimeDouble(900);
        item->addCurve(tempData,curveParam);
    }
    //==================================
    scene->setBackgroundBrush(QBrush(Qt::gray));
...
void MainWindow::addChartDateTimeItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartDateItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartHistogramItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartHistogramItemAdd(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartAreaItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addPie3Item(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//<PSV_Pie3Item>3D圆饼
...
void MainWindow::addCircularIndicatorItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addTableItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//<PSV_TableItem>表格
//        QString title = QString::fromLocal8Bit("表格");//==================================
    ...
    view->setRenderHint(QPainter::Antialiasing);
    //==================================
    QMap<PSV::ATTRIBUTE_ROLE, QVariant> tempParam = param;
    QFont font;
    font.setBold(true);
...
void MainWindow::addTableWidgetItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//PSV_TableWidgetItem
...
void MainWindow::addPainterPathItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//PSV_PainterPathItem
...
void MainWindow::addVerticalIndicatorItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
...
void MainWindow::addChartBarItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//PSV_ChartBarItem
...
void MainWindow::addButtonItem(const QString &title, const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param)
{//PSV_ButtonItem
