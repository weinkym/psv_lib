...
PSV_AxisDownItem::PSV_AxisDownItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param, QGraphicsItem *parent)
    : PSV_AxisItem(param, parent)
{
    updateItem();
}

PSV_AxisDownItem::PSV_AxisDownItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param, const QStringList &list, QGraphicsItem *parent)
