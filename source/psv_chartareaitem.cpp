...
PSV_ChartAreaItem::PSV_ChartAreaItem(const QMap<PSV::ATTRIBUTE_ROLE, QVariant> &param, QGraphicsItem *parent)
...
{
    return QObject::tr("value = %1").arg(QString::number(y,'f',m_decimal));
}
